            ...
            <div
                ...
                <div class="p-4 sm:p-10 overflow-y-auto">
                    <div class="flex gap-x-4 md:gap-x-7">
                        ...
                        <div class="grow">
                            <slot name="title" class="mb-2 text-xl font-bold text-gray-800 dark:text-neutral-200">

                            </slot>
                            <slot name="body" class="text-gray-500 dark:text-neutral-500"></slot>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <a class="py-2 px-6 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-500 text-white hover:bg-red-600 disabled:opacity-50 disabled:pointer-events-none"
                        :data-hs-overlay="`${modalId}`" @click="deleteData" href="#">
                        حذف
                    </a>
                </div>
            </div>
