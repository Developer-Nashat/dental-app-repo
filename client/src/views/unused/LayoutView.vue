...
<template>
    <div class="flex min-h-screen">
        ...
        <TransitionRoot :show="sidebar.isOpened">
            <Dialog as="div" @close="sidebar.setIsOpened(false)" class="fixed inset-0 z-40 md:hidden">
                <TransitionChild as="template" enter="transaction ease-in-out duration-200 transform"
                    ...
                    <div
                        class="relative z-10 flex flex-col h-full py-4 bg-white border-r border-gray-200 md:hidden w-72 shrink-0">
        ...
        <!-- Desktop Sidebar -->
        <div class="hidden w-64 py-4 bg-white border-r border-gray-200 md:block shrink-0">
