...
const schema = yup.object().shape({
    username: yup.string().required('يجب ان تدخل اسم المستخدم'),
    userPassword: yup.string().required('يجب ان تدخل كلمة السر')
});
...
<template>
    <div class="flex items-center justify-center h-screen overflow-auto" style="background: #edf2f7;">
        <div class="flex h-screen">
            ...
            <div class="flex items-center justify-center w-full bg-gray-100 lg:w-1/2">
                <div class="w-full max-w-md p-6">
                    <h1 class="mb-6 text-3xl font-semibold text-center text-black">Sign Up</h1>
                    ...
                    <Form @submit="handleLogin" :validation-schema="schema" class="space-y-4">
                        ...
                        <div>
                            ...
                            <Field v-model="username" type="text" id="username" name="username"
                                class="w-full p-2 mt-1 transition-colors duration-300 border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300" />
                            <ErrorMessage name="username" class="error-feedback" />
                        </div>
                        <div>
                            <label for="userPassword" class="block text-sm font-medium text-gray-700">Password</label>
                            <Field v-model="userPassword" type="password" id="userPassword" name="userPassword"
                                class="w-full p-2 mt-1 transition-colors duration-300 border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300" />
                            <ErrorMessage name="userPassword" class="error-feedback" />
                        </div>
                        <div>
                            <button type="submit"
                                class="w-full p-2 text-white transition-colors duration-300 bg-black rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">Sign
                                Up</button>
